...
$read = "SELECT * FROM department_details;";

// Run query in database and store all data in records array
$records = mysqli_query($conn, $read) or die("Query not run");
        ...
        <body>
            <div class="container mt-md-3">
                ...
                <div class="row row-cols-1 m-md-2 justify-content-center">
                    ...
                    <div class="col mt-md-1 mx-md-2">

                        <!-- ==== All departments header start ==== -->
                        <div class="row row-cols-1 my-md-1">
                            <div class="col bg-secondary text-center">
                                <h2 class="text-white">All Departments</h2>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive-xl">
                            ...
                            <table
                                class="table table-success table-hover text-center table-bordered border-warning"
                                id="all_dept_table">
...
?>
                ...
                <div class="col mt-md-1 mx-md-2">
                    ...
                    <div class="row row-cols-1 my-md-1">
                        <div class="col bg-secondary text-center">
                            <h2 class="text-white">NEW DEPARTMENT</h2>
                        </div>
                    </div>
                    <!-- ==== All departments header end ==== -->
                    <div class="table-responsive-xl">
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" class="btn btn-success">Create
                                                <span class="spinner-border spinner-border-sm"
                                                    role="status" aria-hidden="true" hidden="true"></span>
                                            </button>
